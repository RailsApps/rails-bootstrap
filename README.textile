...
The RailsApps project provides both a "book and Quickstart Guide":http://railsapps.github.io/twitter-bootstrap-rails.html to help you get up to speed with Bootstrap and Rails. Please "join the RailsApps project":http://railsapps.github.io/twitter-bootstrap-rails.html to get both the book and the Quickstart Guide. Subscriptions provide financial support for the RailsApps project.
