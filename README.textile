...
These features demonstrate how Twitter Bootstrap can be used with Rails but are not needed in a starter application so they are not included in the GitHub repository.
