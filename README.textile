...
The RailsApps project provides a "Rails and Bootstrap":http://railsapps.github.io/rails-bootstrap.html Quickstart Guide with details about integrating Rails and Bootstrap.
