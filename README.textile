...
I recommend using the "SimpleForm":http://simple-form.plataformatec.com.br/ gem with Rails. SimpleForm integrates with Bootstrap 2.3. Unfortunately, SimpleForm does not yet support Bootstrap 3.0 (see "issues":https://github.com/plataformatec/simple_form/pull/864). Additionally, a Bootstrap 3 version of the "bootstrap-sass":https://github.com/thomas-mcdonald/bootstrap-sass gem is not yet released (as of Sept. 16, 2013).
