h1. !http://railsapps.github.io/images/rails-36x36.jpg(Rails Bootstrap)! Rails and Twitter Bootstrap

A Rails 4.0 example application that integrates Rails and Twitter Bootstrap.
...
!http://railsapps.github.io/images/tutorial-rails-bootstrap.png(Rails Bootstrap Tutorial)!

A complete tutorial is available:

h4. "View the Tutorial":https://tutorials.railsapps.org/rails-bootstrap
...
The tutorial goes beyond the basic starter application provided here to explore features of Twitter Bootstrap and show how to customize Rails for Twitter Bootstrap.
...
The application does not require a database. No pages are generated using information from a database and no user-submitted data is saved to a database. However, the sqlite3 gem is included in the Gemfile and Rails ActiveRecord can be used to add database functionality to the web application.

h4. Tutorial Application

Additional features shown in the tutorial (but not included in the GitHub repository) include:
...
These features are not needed in a starter application but they demonstrate how Twitter Bootstrap can be used with Rails.
