...
Rails 4.1 example application that integrates Rails and Bootstrap 3.0.
...
Bootstrap 3.0 was released August 19, 2013. This example application uses Rail 4.1 and Bootstrap 3.0.

h4. SimpleForm Issues

Developers often use the "SimpleForm":http://simple-form.plataformatec.com.br/ gem with Rails. SimpleForm integrates with Bootstrap 2.3. Unfortunately, SimpleForm does not fully support Bootstrap 3.0 (see "issues":https://github.com/plataformatec/simple_form/pull/864).
...
"Join the RailsApps project":http://railsapps.github.io/ and get both the book and the tutorial.
