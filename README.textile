h1. !http://railsapps.github.io/images/rails-36x36.jpg(Rails Bootstrap)! Rails and Twitter Bootstrap 3

Rails 4.0 example application that integrates Rails and Twitter Bootstrap 3.

"Bootstrap":http://getbootstrap.com/ provides CSS stylesheets and JavaScript code for the visual design of websites. Bootstrap is a framework for client-side (browser-based or “front end”) development, much like Ruby on Rails is a framework for server-side development.
...
h4. "Get the Tutorial":https://tutorials.railsapps.org/rails-bootstrap
...
These features demonstrate how Twitter Bootstrap can be used with Rails but are not needed in a starter application. The additional code is available here in the GitHub repository in the Git branch named _tutorial_.
